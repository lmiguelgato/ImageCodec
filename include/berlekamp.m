...
%BERLEKAMP Berlekamp-Massey Algorithm for RS and BCH Decoding.  
%   Core algorithm of RSDEC and BCHDEC.
%
...
warnState = warning('off','comm:gettables:gftablewarning');
x1 = x(3).^(0:2^m-2);
warning(warnState);
